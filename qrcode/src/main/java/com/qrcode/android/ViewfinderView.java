...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        maskColor = ContextCompat.getColor(getContext(), R.color.qr_viewfinder_mask);
        resultColor = ContextCompat.getColor(getContext(), R.color.qr_result_view);
        resultPointColor = ContextCompat.getColor(getContext(), R.color.qr_possible_result_points);
