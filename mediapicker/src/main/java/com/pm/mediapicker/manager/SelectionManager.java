package com.pm.mediapicker.manager;
...
public class SelectionManager {
    ...
    private ArrayList<MediaFile> mSelectMedia = new ArrayList<>();
    ...
    public ArrayList<MediaFile> getSelectMdedias() {
        return mSelectMedia;
    }
    ...
    public boolean addMediaToSelectList(MediaFile mediaFile) {
        if (mSelectMedia.contains(mediaFile)) {
            return mSelectMedia.remove(mediaFile);
        } else {
            if (mSelectMedia.size() < mMaxCount) {
                return mSelectMedia.add(mediaFile);
            } else {
                return false;
            }
        }
