...
/**
 * Created by Stephen on 2015/2/10.
 */
public class PTRListViewHeader extends View {
    ...
    public PTRListViewHeader(Context context) {
        this(context, null);
    }

    public PTRListViewHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public PTRListViewHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        if(attrs != null){
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.PTRListViewHeader);

            mRadius = array.getDimensionPixelSize(R.styleable.PTRListViewHeader_header_radius,DEFALUT_RADIUS);
            mStrokeWidth = array.getDimensionPixelSize(R.styleable.PTRListViewHeader_header_width, DEFALUT_STROKE_WIDTH);
