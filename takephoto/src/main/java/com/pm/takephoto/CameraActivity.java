...
import com.pm.takephoto.widget.CropView;
import com.pm.takephoto.widget.FrameOverlayView;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takePictureContainer = (CameraLayout) findViewById(R.id.take_picture_container);
        confirmResultContainer = (CameraLayout) findViewById(R.id.confirm_result_container);
        ...
        cropContainer = (CameraLayout) findViewById(R.id.crop_container);
    ...
    private void doConfirmResult() {
        new Thread() {
            ...
            public void run() {
                ...
                intent.putExtra(CameraActivity.KEY_RESULT_FILE_PATH, contentType);
