 ...
 */
package com.pm.takephoto.widget;
...
import com.pm.takephoto.CameraView;
import com.pm.takephoto.R;
...
public class MaskView extends View {
    ...
    public static final int MASK_TYPE_HANDHELD = 3;
    public static final int MASK_TYPE_BANK_CARD = 11;

    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_HANDHELD, MASK_TYPE_BANK_CARD})
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (w > 0 && h > 0) {
            if (maskType == MASK_TYPE_HANDHELD) {
